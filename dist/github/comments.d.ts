...
export declare function formatIssueComment(allIssues: A11yIssue[], newIssues: A11yIssue[], summary?: string): string;
export declare function formatNoIssuesComment(summary?: string): string;
export declare function formatDraftSkipComment(): string;
export declare function formatNoChangesComment(): string;
export {};
